...
<title><?=$row_home->Title;?> - Update Torah and Resources Step 2</title>
...
?>        
<form enctype="multipart/form-data" class="newform" method="post" action="update-torah-and-resources-step2-script">
...
<textarea id="Description" name="Description" class="large"  style="height:100px;"><?=$row_result->Description?></textarea>
    ...
    <div class="submit">
      <input type="submit" onClick="return TorahResourcesStep2()" name="step2"  value="Next >>"/>     
        <input type="button" value="<< Previous" onClick="window.location='update-torah-and-resources-step1?i=<?php echo $_GET['i'];?>';" class="pre"/>
    </div>
    </form>
<?php }?>
      </fieldset>
...
<script src="js/custom.js"></script>
  <!-- Java Script -->
<script type="text/javascript" src="js/torah-and-resources-step2.js"></script>

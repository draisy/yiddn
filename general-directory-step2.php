...
<title><?=$row_home->Title;?> - Special Offers Step 2</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="general-directory-step2-script">
    ...
    <div class="inputitem">
      ...
      <textarea id="Address" name="Address" class="large"  style="height:100px;"></textarea>
    </div>
...
if (Return==true){
	window.location='update-general-directory-step1?i=<?=base64_encode($_SESSION['OrderId']);?>';

...
<title><?=$row_home->Title;?> - Jewish Local Step 1</title>
...
<br><br>
     ...
     <h3>Jewish Local / POST YOUR LISTING</span></h3>
...
<form enctype="multipart/form-data" class="newform" method="post" action="local-directory-step1-script">
  ...
  <textarea id="CompanyAddress" name="CompanyAddress" class="large"  style="height:100px;"></textarea>
    ...
    <input name="OrderType"  type="hidden" value="Local Directory" />
    </div>

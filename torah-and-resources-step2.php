...
<title><?=$row_home->Title;?> - Torah and Resources Step 2</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="torah-and-resources-step2-script">
...
if (Return==true){
	window.location='update-torah-and-resources-step1?i=<?=base64_encode($_SESSION['OrderId']);?>';

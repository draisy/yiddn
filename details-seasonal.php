...
$categories = 'SELECT * FROM `categories` WHERE `Status`="1" AND  `UseFor`="7" AND  `Seo`="'.$backpath2.'"';
...
*/
$tb_seasonal   = 'SELECT * FROM `tb_seasonal` WHERE `Status`="1" AND `Seo` LIKE "%'.str_replace("-", "%", $pathInfo).'%"  AND (`Category`="'.$data1['Id'].'" OR `Category2`="'.$data1['Id'].'"  OR `Category3`="'.$data1['Id'].'") ORDER BY `CompanyWebsite` ASC';
...
<title><?=$row_home->Title;?> | Seasonal | <?=$data1['Title']?> | <?=$data2['Title']?> | <?=$data3['CompanyName']?></title>
<meta name="keywords" content="<?=$row_home->Title;?>, Seasonal, <?=$data1['Title']?>, <?=$data2['Title']?>, <?=$data3['CompanyName']?>" />
<meta name="Description" content="<?=$row_home->Title;?>,s Seasonal, <?=$data1['Title']?>, <?=$data2['Title']?>, <?=$data3['CompanyName']?>" />

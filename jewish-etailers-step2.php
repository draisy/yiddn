...
<title><?=$row_home->Title;?> - Jewish Retailers Step 2</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="jewish-etailers-step2-script">
...
if (Return==true){
	window.location='update-jewish-etailers-step1?i=<?=base64_encode($_SESSION['OrderId']);?>';

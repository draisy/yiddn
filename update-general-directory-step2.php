...
<title><?=$row_home->Title;?> - Update Special Offers Step 2</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="update-general-directory-step2-script">
...
<textarea id="Address" name="Address" class="large"  style="height:100px;"><?=$row_result->Address;?></textarea>
    </div>
...
<input name="Agent" class="large" value="<?=$row_result->Agent;?>" type="text" />
    </div>
    ...
    <div class="submit">
      <input type="submit" onClick="return GeneralDirectoryStep2()" name="step2"  value="Next >>"/>     
         <input type="button" value="<< Previous" onClick="window.location='update-general-directory-step1?i=<?php echo $_GET['i'];?>';" class="pre"/>
    </div>
...
<script type="text/javascript" src="js/general-directory-step2.js"></script>

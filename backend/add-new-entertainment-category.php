...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-entertainment-category-query.php'); ?>
<head>
<title>Add New Jewish Entertainment Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Jewish Entertainment Category </h1>
  </div>
  <div class="row">

...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-services-sub-category-query.php'); ?>
<head>
<title>Edit Services Sub-Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Services Sub-Category </h1>
  </div>
  <div class="row">

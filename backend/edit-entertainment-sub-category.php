...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-entertainment-sub-category-query.php'); ?>
<head>
<title>Edit Jewish Entertainment Sub Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Jewish Entertainment Sub Category </h1>
  </div>
  <div class="row">

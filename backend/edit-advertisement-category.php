...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-advertisement-category-query.php'); ?>
<head>
<title>Edit General Directory Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit General Directory Category </h1>
  </div>
  <div class="row">
...
<?php 
$query = "select * from `categories` where `UseFor`='1' AND  `Id`= ".base64_decode($_GET['y']);

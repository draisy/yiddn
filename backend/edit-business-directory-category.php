...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-business-directory-category-query.php'); ?>
<head>
<title>Edit Jewish E-Tailers Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Jewish E-Tailers Category </h1>
  </div>
  <div class="row">
...
<?php 
$query = "select * from `categories` where `UseFor`='2' AND  `Id`= ".base64_decode($_GET['y']);

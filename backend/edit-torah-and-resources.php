...
if(isset($_GET['n']) && isset($_GET['c'])) {
 	...
 	$sql  = "UPDATE `tb_torah_resources` SET `CompanyLogo`='' Where `Id_torah_resources`= '".base64_decode($_GET['i'])."'";
...
if(isset($_GET['n']) && isset($_GET['b'])) {
		...
		{  
  		...
  		$sql  = "UPDATE `tb_torah_resources` SET `".$_GET['Banner']."`=''  Where `Id_torah_resources`= '".base64_decode($_GET['i'])."'";
		$res = mysqli_query($db, $sql);
	echo "<script>window.open('edit-torah-and-resources?i=".$_GET['i']."','_self')</script>";
}
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-torah-and-resources-query.php'); ?>
<head>
<title>Edit Torah & Torah & Resources - <?php echo $row_home->Title;?></title>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="widget-container fluid-height clearfix">
            <div class="heading"><i class="icon-edit-sign"></i>Edit Torah & Resources</div>
...
<?php 
$query = "select * from `tb_torah_resources` where `Id_torah_resources`= '".base64_decode($_GET['i'])."'";
...
?> 
      ...
      <fieldset>
        ...
        <input type="hidden" id="Id" name="Id" value="<?php echo $row_result->Id_torah_resources;?>" />
...
<a href="../images/CompanyLogo/<?php echo $row_result->CompanyLogo;?>" target="_blank"><img src="../images/CompanyLogo/<?php echo $row_result->CompanyLogo;?>" width="100" /></a>
     <a href='edit-torah-and-resources?i=<?php echo $_GET['i'];?>&n=<?php echo $row_result->CompanyLogo;?>&c=c' onclick='return DeleteLogo();'>Delete</a>
<?php }?> 
<script>
function DeleteLogo()
{
...
<?php
$query = 'SELECT * FROM `categories` WHERE  `UseFor`="4" ORDER By Title ASC';
$result = $db->query($query);
...
<a href='edit-torah-and-resources?i=<?php echo $_GET['i'];?>&n=<?php echo $row_result->Banner;?>&b=b&Banner=Banner' onclick='return DeleteBanner();'>Delete</a>
<?php }?> 
<script>
...
<img src="../images/Banner/<?php echo $row_result->Banner2;?>" width="100" /></a>
    <a href='edit-torah-and-resources?i=<?php echo $_GET['i'];?>&n=<?php echo $row_result->Banner2;?>&b=b&Banner=Banner2' onclick='return DeleteBanner();'>Delete</a>
    <?php }?> 
    <script>
		function DeleteBanner()
		{
...
<img src="../images/Banner/<?php echo $row_result->Banner3;?>" width="100" /></a>
        <a href='edit-torah-and-resources?i=<?php echo $_GET['i'];?>&n=<?php echo $row_result->Banner3;?>&b=b&Banner=Banner3' onclick='return DeleteBanner();'>Delete</a>
        <?php }?> 
        <script>
            function DeleteBanner()
            {
...
<input type="hidden" name="OrderType"      id="OrderType" value="Torah & Resources" />
      </fieldset>
      </span>

...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-local-directory-sub-category-query.php'); ?>
<head>
<title>Add New Local Directory Sub Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Local Directory Sub Category </h1>
  </div>
  <div class="row">

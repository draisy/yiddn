...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-services-sub-category-query.php'); ?>
<head>
<title>Add New Services Sub-Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Services Sub Category </h1>
  </div>
  <div class="row">
              ...
              <form method="post">
                ...
                <label for="Title">Select Category</label>
                 <select class="select2able" name="Category" required>
					...
					<?php
                    $Category = 'SELECT * FROM `categories` WHERE `UseFor`="6" AND `Status`="1"';

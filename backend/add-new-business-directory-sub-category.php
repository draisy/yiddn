...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-business-directory-sub-category-query.php'); ?>
<head>
<title>Add New Jewish E-Tailers Sub Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Jewish E-Tailers Sub Category </h1>
  </div>
  <div class="row">
              ...
              <form method="post">
                ...
                <label for="Title">Select Category</label>
                 <select class="select2able" name="Category" required>
					...
					<?php
                    $Category = 'SELECT * FROM `categories` WHERE `UseFor`="2" AND `Status`="1"';

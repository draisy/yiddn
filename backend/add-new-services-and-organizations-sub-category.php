...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-services-and-organizations-sub-category-query.php'); ?>
<head>
<title>Add New Torah & Resources Sub Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Torah & Resources Sub Category </h1>
  </div>
  <div class="row">

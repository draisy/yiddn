...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-business-directory-category-query.php'); ?>
<head>
<title>Add New Jewish E-Tailers Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Jewish E-Tailers Category </h1>
  </div>
  <div class="row">

...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-advertisement-category-query.php'); ?>
<head>
<title>Add New General Directory Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New General Directory Category </h1>
  </div>
  <div class="row">

...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-services-category-query.php'); ?>
<head>
<title>Add New Services Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Services Category </h1>
  </div>
  <div class="row">

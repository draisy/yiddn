...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-services-and-organizations-category-query.php'); ?>
<head>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Torah & Resources Category </h1>
  </div>
  <div class="row">
...
<?php 
$query = "select * from `categories` where `UseFor`='4' AND  `Id`= ".base64_decode($_GET['y']);

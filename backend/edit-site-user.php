...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-site-user-query.php'); ?>
<head>
...
?>
            <div class="widget-content padded">
              <form method="post">
                  ...
                  <input class="form-control" id="FirstName" name="FirstName" placeholder="First Name" type="text" value="<?php echo $row_account->FirstName;?>"/>
                </div>
                
                <div class="form-group">
                  <label for="LastName">Last Name</label>
                  <input class="form-control" id="LastName" name="LastName" placeholder="Last Name" type="text" value="<?php echo $row_account->LastName;?>" />
                </div>
                
               <div class="form-group">
                  <label for="City">City</label>
                  <input class="form-control" id="City" name="City" placeholder="City" type="text" value="<?php echo $row_account->City;?>" />
                </div>
                
                <div class="form-group">
                  <label for="StateProvince">State / Province</label>
                  <input class="form-control" id="StateProvince" name="StateProvince" placeholder="State / Province" type="text" value="<?php echo $row_account->StateProvince;?>" />
                </div>
                
                <div class="form-group">
                  <label for="Zipcode">Zipcode</label>
                  <input class="form-control" id="Zipcode" name="Zipcode" placeholder="Zipcode" type="text" value="<?php echo $row_account->Zipcode;?>" />
                </div>
                
                <div class="form-group">
                  <label for="Country">Country</label>
                  <input class="form-control" id="Country" name="Country" placeholder="Country" type="text" value="<?php echo $row_account->Country;?>" />
                </div>
               ...
               <span id="Info"></span>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="PhoneNumber" name="PhoneNumber" placeholder="Phone Number" type="text" value="<?php echo $row_account->PhoneNumber;?>" />
                </div>
                
                <div class="form-group">
                  <label for="OurSite">How did you hear about our site?</label>
                  <input class="form-control" id="OurSite" name="OurSite" placeholder="How did you hear about our site?" type="text" value="<?php echo $row_account->OurSite;?>" />
                </div>
                
                <div class="form-group">
                    <label class="checkbox-inline">
                    <input type="checkbox" value="yes" checked name="EmailList" <?php if($row_account->OurSite=="yes"){echo 'checked';}?>   />

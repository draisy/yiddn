...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-local-directory-sub-category-query.php'); ?>
<head>
<title>Edit Local Directory Sub Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Local Directory Sub Category </h1>
  </div>
  <div class="row">
              ...
              <div class="form-group">
                <label for="Title">Select Category</label>
                 <select class="select2able" name="Category" required>
					...
					<?php
                    $Category = 'SELECT * FROM `categories` WHERE `UseFor`="3" AND `Status`="1"';
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="Title" type="text" value="<?php echo $row->Title;?>" disabled />
                  <input class="form-control" id="Title" name="Title" placeholder="Title" type="hidden" value="<?php echo $row->Title;?>" />

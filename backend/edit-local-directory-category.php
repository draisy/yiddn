...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-local-directory-category-query.php'); ?>
<head>
<title>Edit Local Directory Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Local Directory Category </h1>
  </div>
  <div class="row">
...
<?php 
$query = "select * from `categories` where `UseFor`='3' AND  `Id`= ".base64_decode($_GET['y']);

...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-business-directory-sub-category-query.php'); ?>
<head>
<title>Edit Jewish E-Tailers Sub Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Jewish E-Tailers Sub Category </h1>
  </div>
  <div class="row">

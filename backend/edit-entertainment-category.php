...
?>
<!DOCTYPE html>
<html><?php require_once('query/edit-entertainment-category-query.php'); ?>
<head>
<title>Edit Jewish Entertainment Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Edit Jewish Entertainment Category </h1>
  </div>
  <div class="row">
...
<?php 
$query = "select * from `categories` where `UseFor`='5' AND  `Id`= ".base64_decode($_GET['y']);

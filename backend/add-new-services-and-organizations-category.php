...
?>
<!DOCTYPE html>
<html><?php require_once('query/add-new-services-and-organizations-category-query.php'); ?>
<head>
<title>Add New Torah & Resources Category - <?php echo $row_home->Title;?></title>
...
<div class="container-fluid">
  <div class="page-title">
    <h1> Add New Torah & Resources Category </h1>
  </div>
  <div class="row">

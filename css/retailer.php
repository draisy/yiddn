...
<title><?=$row_home->Title;?> | Retailer</title>
...
<!--Header -->  
 ...
 <!--/Navigation -->
    ...
    <h2>Retailers</h2>
    <p style="font-style:italic;">If it’s here, it’s kosher: fine foods, travel services, apparel, gifts and much more.</p>
 	<br>
<?php
$c = 1;
echo '<div class="abcorder">'; 
$categories_ = 'SELECT * FROM `categories` WHERE `Status`="1" AND  `UseFor`="2" Order by `Title` ASC';
...
echo '<li><a href="retailer/'.$data['Seo'].'/'.$data_row['Seo'].'">'.$data_row['Title'].'</a></li>';	
}
echo "</ul></article>"; 
if($b==16){
	echo "</div><div style='float:left; display:inline-block;'>";
	$c = 1;
	}

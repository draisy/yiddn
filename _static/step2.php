...
<br><br>
    ...
    <label class="title">Description:</label>
      <textarea class="large" type="email" name="email"  style="height:100px;" value=""/></textarea>
    </div>
    
    
    
     <div class="inputitem">
    <label class="title">Agent: (optional)</label>
     <input class="large" type="email" name="email" value=""/>
    </div>
    ...
    <label class="title">Keywords:</label>
     <input class="large" type="email" name="email" value=""/>
     <span class="purpule">Keywords are the most important element for the search feature. List as many keywords as possible for the best results. "please separate the keywords with commas"</span>
      ...
      <div class="submit">
      <input type="submit" value="Next >>"/>       <input type="submit" value="<< Previous" class="pre"/>

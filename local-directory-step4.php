...
<title><?=$row_home->Title;?> - Jewish Local Step 4</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="local-directory-step4-script">
<?php
$tb_local = 'SELECT * FROM `tb_local` WHERE `OrderId`="'.$_SESSION['OrderId'].'"';
...
<select name="ExpYear" id="ExpYear" title="select a year" style="width:100px;"> 
	 ...
	 echo '<option value="'.$year.'">'.$year.'</option>';
      ...
      <div class="submit">
         <input type="submit"  name="step4" onClick="return LocalDirectoryStep4s()" value="Submit"/>  
...
if (Return==true){
	window.location='update-local-directory-step3?i=<?=base64_encode($_SESSION['OrderId']);?>';

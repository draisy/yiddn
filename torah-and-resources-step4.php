...
<title><?=$row_home->Title;?> - Torah and Resources Step 4</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="torah-and-resources-step4-script">
<?php
$tb_etailer = 'SELECT * FROM `tb_torah_resources` WHERE `OrderId`="'.$_SESSION['OrderId'].'"';
...
<select name="ExpYear" id="ExpYear" title="select a year" style="width:100px;"> 
	 ...
	 echo '<option value="'.$year.'">'.$year.'</option>';
      ...
      <div class="submit">
         <input type="submit"  name="step4" onClick="return TorahResourcesStep4s()" value="Submit"/>  
...
if (Return==true){
	window.location='update-torah-and-resources-step3?i=<?=base64_encode($_SESSION['OrderId']);?>';

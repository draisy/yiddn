...
<title><?=$row_home->Title;?> - Update Local Directory Step 4</title>
...
<script type="text/javascript" src="js/local-directory-step4.js"></script>
...
<form enctype="multipart/form-data" class="newform" method="post" action="update-local-directory-step4-script">
<?php
$tb_local = "SELECT * FROM `tb_local` WHERE `OrderId`='".base64_decode($_GET['i'])."'";
...
<select name="ExpYear" id="ExpYear" title="select a year" style="width:100px;"> 
	 ...
	 echo '<option value="'.$year.'">'.$year.'</option>';
      ...
      <div class="submit">
         <input type="submit"  name="step4" onClick="return LocalDirectoryStep4()" value="Submit"/>  
<input type="button" value="<< Previous" onClick="window.location='update-local-directory-step3?i=<?php echo $_GET['i'];?>';" class="pre"/>      </div>

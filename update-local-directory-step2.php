...
<title><?=$row_home->Title;?> - Update Local Directory Step 2</title>
...
?>        
<form enctype="multipart/form-data" class="newform" method="post" action="update-local-directory-step2-script">
...
<textarea id="Description" name="Description" class="large"  style="height:100px;"><?=$row_result->Description?></textarea>
    ...
    <div class="submit">
      <input type="submit" onClick="return LocalDirectoryStep2()" name="step2"  value="Next >>"/>     
        <input type="button" value="<< Previous" onClick="window.location='update-local-directory-step1?i=<?php echo $_GET['i'];?>';" class="pre"/>
    </div>
    </form>
<?php }?>
      </fieldset>
...
<script type="text/javascript" src="js/local-directory-step2.js"></script>

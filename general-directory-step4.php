...
<title><?=$row_home->Title;?> - Special Offers Step 4</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="general-directory-step4-script">
<?php
...
if (Return==true){
	window.location='update-general-directory-step3?i=<?=base64_encode($_SESSION['OrderId']);?>';

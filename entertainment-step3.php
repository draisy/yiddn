...
<title><?=$row_home->Title;?> - Entertainment Step 3</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="entertainment-step3-script">      
...
<div class="submit">
<input type="submit" onClick="return EntertainmentStep3()" id="step3" name="step3"  value="Submit"/>     
...
if (Return==true){
	window.location='update-entertainment-step2?i=<?=base64_encode($_SESSION['OrderId']);?>';
...
<div id="modal" class="modal">
    ...
    <fieldset>
       ...
       <div class="inputitem"> 
        ...
        <input  id="RequestIN" name="RequestIN" type="hidden" value="Entertainment" />

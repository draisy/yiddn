...
$categories = 'SELECT * FROM `categories` WHERE `Status`="1" AND  `UseFor`="4" AND  `Seo`="'.$pathInfo.'"';
...
<head>
<meta charset="utf-8">
<title><?=$row_home->Title;?> | Torah Resources | <?=$data['Title']?></title>
<meta name="keywords" content="<?=$row_home->Title;?>, Torah Resources, <?=$data['Title']?>" />
<meta name="Description" content="<?=$row_home->Title;?>, Torah Resources, <?=$data['Title']?>" />
...
<!--Header -->  
 ...
 <!--/Navigation -->
    ...
    <h2><a href="<?=ADDRESS_SITE?>torah-and-resources">Torah Resources</a><span> | <?=$data['Title']?></span></h2>
...
<?php if($filename !="" && $filename !="staticads/torah-and-resources/Thumbs.db"){?>

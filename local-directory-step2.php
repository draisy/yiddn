...
<title><?=$row_home->Title;?> - Jewish Local Step 2</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="local-directory-step2-script">
...
if (Return==true){
	window.location='update-local-directory-step1?i=<?=base64_encode($_SESSION['OrderId']);?>';

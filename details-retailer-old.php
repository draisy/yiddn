...
<img class="CompanyLogo" src="<?php echo ADDRESS_SITE;?>images/CompanyLogo/<?php echo $data3['CompanyLogo']; ?>" width="300" />
<?php }else{?>
<img class="CompanyLogo" src="<?php echo ADDRESS_SITE;?>images/Picture-Not-Available.gif" width="300" />
<?php }?><br><br><br><br>
...
<?php require_once('ads-retailer.php'); ?>

...
<title><?=$row_home->Title;?> - Jewish Local Step 3</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="local-directory-step3-script">      
...
<select name="City" id="City">
    ...
    <span>Yes, I want to upgrade to a BOLD listing - only $4.99 a month.</span>
     ...
     <label>
<input type="checkbox" name="Premium" value="199" id="Premium"  class="chk" onclick="showMe('div1')" />
...
<fieldset class="newfiled">
    <legend><h5>City 2 (<span style="font-size:14px; color:#8A0E6E;">optional</span>)</h5></legend>
    <div class="inputitem">
...
<select name="City2">
   ...
   <?php
    ...
    <span>Yes, I want to upgrade to a BOLD listing - only $4.99 a month.</span>
     ...
     <span class="clearfix"></span>
   <label> 
<input type="checkbox" name="Premium2" value="199" id="Premium2" class="chk" onclick="showMe('div2')"/>
<span>Upgrade to premium for maximum impact with a banner ad display - for only $99 a month.</span>
    </label>
...
<fieldset class="newfiled">
      <legend><h5>City 3 (<span style="font-size:14px; color:#8A0E6E;">optional</span>)</h5></legend>
    <div class="inputitem">
      <label class="title"></label><div class="item-cont">
<select name="City3">
    <option value="">Please select</option>
...
<input type="checkbox" name="upgrade3" value="4.99" id="upgrade3"/>
    <span>Yes, I want to upgrade to a BOLD listing - only $4.99 a month.</span>
     ...
     <label>        
<input type="checkbox" name="Premium3" value="199" id="Premium3" class="chk" onclick="showMe('div3')"/>
<span>Upgrade to premium for maximum impact with a banner ad display - for only $99 a month.</span>
    </label>
...
<input name="orderid"  value="<?=$_SESSION['OrderId']?>" id="orderid" type="hidden"  />
    ...
    <div class="submit">
      <input type="submit" onClick="return LocalDirectoryStep3()" id="step3" name="step3"  value="Submit"/> 
...
if (Return==true){
	window.location='update-local-directory-step2?i=<?=base64_encode($_SESSION['OrderId']);?>';
...
<div id="modal" class="modal">
    ...
    <fieldset>
       ...
       <div class="inputitem"> 
        ...
        <input  id="RequestIN" name="RequestIN" type="hidden" value="Local Directory" />

...
<title><?=$row_home->Title;?> - Torah and Resources Step 3</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="torah-and-resources-step3-script">      
...
<input name="orderid"  value="<?=$_SESSION['OrderId']?>" id="orderid" type="hidden"  />
    ...
    <div class="submit">
      <input type="submit" onClick="return TorahResourcesStep3()" id="step3" name="step3"  value="Submit"/> 
...
if (Return==true){
	window.location='update-torah-and-resources-step2?i=<?=base64_encode($_SESSION['OrderId']);?>';

...
$categories = 'SELECT * FROM `categories` WHERE `Status`="1" AND  `UseFor`="5" AND  `Seo`="'.$pathInfo.'"';
...
<head>
<meta charset="utf-8">
<title><?=$row_home->Title;?> | Entertainment | <?=$data['Title']?></title>
<meta name="keywords" content="<?=$row_home->Title;?>, Entertainment, <?=$data['Title']?>" />
<meta name="Description" content="<?=$row_home->Title;?>, Entertainment, <?=$data['Title']?>" />

...
<title><?=$row_home->Title;?> - Torah and Resources Step 1</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="torah-and-resources-step1-script">

...
<title><?=$row_home->Title;?> - Update Torah and Resources Step 4</title>
...
<script type="text/javascript" src="js/torah-and-resources-step4.js"></script>
...
<form enctype="multipart/form-data" class="newform" method="post" action="update-torah-and-resources-step4-script">
<?php
$tb_torah_resources = "SELECT * FROM `tb_torah_resources` WHERE `OrderId`='".base64_decode($_GET['i'])."'";
...
<input name="OrderId"  value="<?=base64_decode($_GET['i'])?>" id="OrderId" type="hidden"  />
      ...
      <div class="submit">
         <input type="submit"  name="step4" onClick="return TorahResourcesStep4()" value="Submit"/>  
<input type="button" value="<< Previous" onClick="window.location='update-torah-and-resources-step3?i=<?php echo $_GET['i'];?>';" class="pre"/>      </div>

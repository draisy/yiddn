...
<title><?=$row_home->Title;?> - Update Entertainment Step 4</title>
...
<form enctype="multipart/form-data" class="newform" method="post" action="update-entertainment-step4-script">
<?php
$tb_entertainment = "SELECT * FROM `tb_entertainment` WHERE `OrderId`='".base64_decode($_GET['i'])."'";
...
<select name="ExpYear" id="ExpYear" title="select a year" style="width:100px;"> 
	 ...
	 echo '<option value="'.$year.'">'.$year.'</option>';
      ...
      <div class="submit">
         <input type="submit"  name="step4" onClick="return EntertainmentStep4()" value="Submit"/>  
<input type="button" value="<< Previous" onClick="window.location='update-entertainment-step3?i=<?php echo $_GET['i'];?>
';" class="pre"/>      </div>
